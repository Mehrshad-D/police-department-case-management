...
urlpatterns = [
    ...
    path('interrogations/<int:pk>/', views.InterrogationDetailView.as_view(), name='interrogation-detail'),
    ...
    path('interrogations/<int:pk>/chief-review/', views.InterrogationChiefReviewView.as_view(), name='interrogation-chief-review'),
