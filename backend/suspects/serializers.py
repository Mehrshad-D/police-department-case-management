...
class InterrogationSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = [
            ...
            'chief_confirmed', 'chief_notes', 'chief_confirmed_at', 'created_at', 'updated_at',
        ]
...
class InterrogationChiefReviewSerializer(serializers.Serializer):
    """Chief approves or rejects captain decision."""
    action = serializers.ChoiceField(choices=['approve', 'reject'])
